...
def load_transactions(file_name):
    '''
    Функция открывает файл с данными вопросов и возвращает в виде списка словарей
    '''
...
def make_up_data_to_print(oper):
    ...
    if check_key_is_exist(oper, 'date'):
        ...
        date = 'No date'
    #Проверим наличие данных в операции и сформируем первую строку для вывода
    ...
    if check_key_is_exist(oper, 'to'): #Проверим наличие поля "куда" в операции м вставим в строку
